...
export const getMigrateSharedDisks = (resource: V1beta1Plan): boolean =>
  (resource as EnhancedPlan)?.spec?.migrateSharedDisks ?? true; // When missing, default behavior is true, follow BE description: https://github.com/kubev2v/forklift/pull/1318#issue-2812305530
